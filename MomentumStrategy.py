...
class MomentumStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.indicators = {}
        self.sorted_data = []
        #  store the SP500 (this is the index) data as the first item of the dataset
        ...
        # SMA for SP500 index -  open long positions when the SP500 index
    ...
    def rebalance_portfolio(self):
        ...
        # open long positions when the SMA is below the SP500 index
